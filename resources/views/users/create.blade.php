              ...
              <div class="card-title">
                ...
                <form action="{{route('users.store')}}" method="POST">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="email" class="form-control" name="email" placeholder="Enter Your Category name" required>
                  </div>
                  <div class="mb-3">
                    <label for="" class="col-form-label">password</label>
                    <input type="password" class="form-control" name="password" placeholder="Enter Your Category name" required>
                  </div>
