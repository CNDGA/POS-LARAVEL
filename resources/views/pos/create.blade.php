            ...
            <div x-show="filteredProducts().length" class="grid grid-cols-4 gap-4 pb-3">
              <template x-for="product in filteredProducts()" :key="product.id">
                ...
                >
                  ...
                  <div class="px-3 py-2">
                    <!-- Name -->
                    <p class="text-sm font-medium truncate text-gray-800 mb-1" x-text="product.name"></p>
            
                    <!-- Price -->
                    <p class="text-base font-semibold text-gray-900" x-text="priceFormat(product.price)"></p>
                  </div>
                </div>
              </template>
            </div>
